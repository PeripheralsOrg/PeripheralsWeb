...
@section('css', 'home/termos')
@section('title')@parent Termos e condições @stop

@section('content')
    <article class="about-content">
            <h2>Política Privacidade</h2>
            <p>A sua privacidade é importante para nós. É política do 2ucase respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="{{route('client-homepage')}}">Peripherals</a>, e outros sites que possuímos e operamos.</p>
            ...
            <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar
                responsabilidade por suas respectivas <strong>políticas de privacidade</strong>. </p>
            ...
            <h2>Política de Cookies 2UCASE</h2>
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o 2ucase oferece no site e com caráter enunciativo, mas não limitativo:</p>
            <ul id="lista-padding">
                ...
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do 2ucase, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
            </ul>
            <h3>Mais informações</h3>
            <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
            <p>Esta política é efetiva a partir de <strong>Nov</strong>/<strong>2022</strong>.</p>
        </article>
@endsection
