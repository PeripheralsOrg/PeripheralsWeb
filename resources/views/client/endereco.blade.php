...
@section('content')
    <main class="content-endereco">
        ...
        <form action="{{ route('select-endereco') }}" method="GET">
            ...
            <div class="box-buttons">
                <button type="submit" class="btn-delete">Prosseguir</button>
            </div>
        </form>
        ...
        <form class="content-form" action="{{ route('insert-endereco') }}" method="POST">
