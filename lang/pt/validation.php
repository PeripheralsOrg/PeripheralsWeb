...
return [
    ...
    */
    ...
    'custom' => [
        'collectionGastos' => [
            'required' => 'É necessário informar os gastos do mês informado para continuar!',
            'json' => 'Ocorreu um erro ao enviar o formulário. Por favor, tente novamente em alguns instantes'
        ],

        'FaturaC' => [
            'numeric' => 'O campo :attribute deve conter apenas dígitos'
        ],
    ...
    'attributes' => [
        ...
        'message' => 'mensagem',
        'month-year' => 'Mês',
        'FaturaC' => 'faturamento do cartão',
        'FaturaD' => 'faturamento em dinheiro',
        'collectionGastos' => 'Gastos no mês informado'
    ],
